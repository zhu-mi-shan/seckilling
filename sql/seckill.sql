...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ticket_ticket_id_fk` FOREIGN KEY (`ticket_id`) REFERENCES `ticket` (`ticket_id`),
...
INSERT INTO `orders` VALUES (344,1,19,1),(345,1,19,1),(346,1,19,1);
...
INSERT INTO `role_permission` VALUES (9,1),(9,4),(9,2),(2,1),(3,1),(3,2),(3,3),(6,1),(6,2),(6,3),(6,4),(6,5),(6,6),(1,2),(1,3),(1,1),(1,5),(6,10),(6,11),(6,12);
...
INSERT INTO `ticket` VALUES (19,'党支部讲党课',794,0,'2023-12-15 16:00:00','2023-12-16 16:00:00','党员、预备党员和入党积极分子参与'),(20,'桌游活动',12,50,'2023-12-14 16:00:00','2023-12-19 16:00:00','去桌游店玩桌游'),(21,'动物园游览',20,80,'2023-12-21 16:00:00','2023-12-25 16:00:00','去北京动物园玩'),(22,'歌剧鉴赏',0,100,'2023-12-22 16:00:00','2023-12-28 16:00:00','去欣赏歌剧'),(23,'新的活动',0,20,'2023-12-20 16:00:00','2023-12-23 16:00:00','一个神秘活动');
...
INSERT INTO `user` VALUES (1,'www','123','小王','13212345678','男'),(2,'ddd','1234','小丁','13545488978','女'),(24,'zzz','123','啧啧啧','1654165488','女'),(28,'poi','123','poi','26541616222','男'),(30,'aaa','123','啊啊','123124314','男');
...
INSERT INTO `user_role` VALUES (24,2),(1,3),(1,6),(1,1),(1,2),(2,2),(2,9),(28,2),(28,9),(28,1),(28,3),(30,2),(30,1);
...
-- Dump completed on 2023-12-19 16:22:42
